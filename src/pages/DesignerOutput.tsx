      ...
      <div className="pt-24 pb-8 px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex justify-center gap-8 mt-12 ml-16 mx-[400px] my-[15px]">
            ...
            <button onClick={handleDownloadRendering} className="px-8 py-4 bg-holo-white border-2 border-holo-teal text-holo-black rounded-[32px] font-inter font-medium text-lg hover:bg-holo-teal/10 transition-colors duration-200 flex items-center justify-center gap-2">
              <Download className="text-holo-teal" size={20} />
              <span>Analysis</span>
            </button>
            <button onClick={handleViewInVR} className="px-8 py-4 bg-holo-white border-2 border-holo-teal text-holo-black rounded-[32px] font-inter font-medium text-lg hover:bg-holo-teal/10 transition-colors duration-200 flex items-center justify-center gap-2">
