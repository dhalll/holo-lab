...
              </div>
                ...
                <div className="absolute inset-0 mx-[16px] my-[13px]">
...
              }].map(tab => (
                    <button 
                        ...
                        className={`flex-1 px-3 py-3 text-xs font-inter font-medium transition-colors duration-200 ${activeTab === tab.id ? 'text-holo-coral border-b-2 border-holo-coral bg-holo-coral/5' : 'text-gray-600 hover:text-holo-black hover:bg-gray-50'}`}>
                    {tab.label}
                  </button>
                ))}
              </div>

              <div className="-space-y-6 "> {/* This negative margin might need adjustment if content overlaps after other changes */}
                {activeTab === 'materials' && (
                    <div>
...
                              <td className="py-3 font-inter font-semibold text-holo-coral">
                                    {material.reuse}%
                                </td>
                            </tr>
                            ))}
...
                          </div>
                          <p className="text-xs font-inter font-medium text-holo-black">
                                {joint.name}
                            </p>
