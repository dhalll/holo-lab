    ...
    <div className="min-h-screen bg-holo-white font-inter relative">
      ...
      <div className="flex flex-col items-center px-8 pt-16 pb-8 min-h-screen">
        <div className="flex gap-8 w-full max-w-7xl" style={{ height: '60vh' }}>
          {/* Left: Preview Window - 60% width */}
          <div className="w-[60%] bg-gradient-to-br from-gray-900 to-gray-700 rounded-lg border-2 border-holo-teal relative overflow-hidden">
            <ThreeScene />
          </div>

          {/* Right: AI Chat Panel - 40% width */}
          <div className="w-[40%] bg-gradient-white-teal rounded-lg flex flex-col">
            {/* Chat Header */}
            <div className="p-6 border-b border-holo-teal/20">
              <div className="flex justify-between items-center">
                ...
                <div className="flex space-x-2">
                  <button className="w-10 h-10 rounded-full bg-holo-black border-2 border-holo-coral text-holo-teal flex items-center justify-center hover:scale-105 transition-transform">
                    <Database size={20} />
                  </button>
                  <button className="w-10 h-10 rounded-full bg-holo-black border-2 border-holo-coral text-holo-teal flex items-center justify-center hover:scale-105 transition-transform">
                    <Building size={20} />
            ...
            {/* Chat Input */}
            <div className="p-6 border-t border-holo-teal/20">
              <div className="flex gap-3">
                <input
                  ...
                  className="flex-1 px-4 py-3 h-[56px] border-2 border-holo-teal rounded-[32px] focus:outline-none focus:ring-2 focus:ring-holo-coral placeholder:text-holo-teal"
                />
                <button
                  onClick={handleSendMessage}
                  className="w-10 h-10 bg-holo-coral text-white rounded-full flex items-center justify-center hover:scale-105 transition-transform"
                >
                  <Send size={20} />
                </button>
              </div>
